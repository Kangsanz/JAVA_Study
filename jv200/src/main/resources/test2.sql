...
-- 문제2-------------------------------------------------------------------------
INSERT INTO Customer2 (name, ssn) VALUES ('James Bond', '900101-1234567');
INSERT INTO Account2 (accountType, balance, interestRate, overdraftAmount, customerId) VALUES ('C', '2000.0', '0.03', '0.0', '1001');
UPDATE Customer2 SET name='Jason Bourne' WHERE cid='1002';
DELETE FROM Customer2 WHERE cid='1002';
SELECT accountType, balance FROM Account2 WHERE aid='3001';